...
from factories.siamese_bert_classifier_factory import SiameseBertClassifierFactory
from pytorch_pretrained_bert import BertTokenizer
from pytorch_pretrained_bert.optimization import BertAdam
from train.tuning import ConfigurableTrainerFitResultFactory


class BertSiameseConfigurableTrainer(tuning.ConfigurableTrainer):

    def __load_model(self, params, processor):
        label_list = processor.get_labels()
        return SiameseBertClassifierFactory.create_model(params["bert_model"], params["additional_embedding_layer_size"], params["pooler_type"],
    ...
    def __create_multiclass_evaluators(self, params, model, val_dataset, tokenizer, device):
        ...
        train_evaluator = evaluators.SiameseBertSupervisedTrainEvaluator(metric_info_seq=train_metric_info_seq)
        ...
        val_evaluator = evaluators.SiameseBertSupervisedValidationEvaluator(model, val_dataloader,
    ...
    def __create_mnli_val_mm_evaluator(self, params, model, tokenizer, device):
        ...
        return evaluators.SiameseBertSupervisedValidationEvaluator(model, val_mm_dataloader,
    ...
    def __create_snli_test_evaluator(self, params, model, tokenizer, device):
        ...
        return evaluators.SiameseBertSupervisedValidationEvaluator(model, test_dataloader,
    ...
    def fit(self, params):
        ...
        trainer = trainers.SiameseBertDistillationTrainer(model, opt, loss_fn,
